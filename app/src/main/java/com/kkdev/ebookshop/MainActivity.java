...
import com.kkdev.ebookshop.databinding.ActivityMainBinding;
import com.kkdev.ebookshop.model.Book;
import com.kkdev.ebookshop.model.Category;
import com.kkdev.ebookshop.viewmodel.MainActivityViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int ADD_BOOK_REQUES_CODE=1;
    public static final int EDIT_BOOK_REQUES_CODE=2;
    ...
    private void loadRecyclerView(){
        ...
        booksAdapter.setListener(new BooksAdapter.OnItemClickListener() {
            ...
            public void onItemClick(Book book) {
                ...
                startActivityForResult(intent,EDIT_BOOK_REQUES_CODE);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode== ADD_BOOK_REQUES_CODE && resultCode== RESULT_OK){
        ...
        }else if (requestCode== EDIT_BOOK_REQUES_CODE && resultCode== RESULT_OK){
            Book book = new Book();
            book.setCategoryId(selectedCategoryId);
            book.setBookName(data.getStringExtra(AddAndEditActivity.BOOK_NAME));
            book.setUnitPrice(data.getStringExtra(AddAndEditActivity.UNIT_PRICE));
